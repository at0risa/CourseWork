#include "MyForm.h" // підключаємо файл з формою MyForm.h
#pragma once
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Segoe UI Variable Display", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->ForeColor = System::Drawing::Color::White;
			this->label1->Location = System::Drawing::Point(35, 177);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(706, 190);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Вітаю! Ви знаходитесь в програмі \r\nдля швидкої перевірки знань за \r\nтемою \"Елемен"
				L"ти керування і події Windows Forms\", \r\nрозробленою студенткою \r\nгрупи КІ2-22-1 С"
				L"ироти Софії\r\n";
			...
			this->button1->Location = System::Drawing::Point(309, 499);
			...
			this->button1->Click += gcnew System::EventHandler(this, &GreetingForm::button1_Click);
			// 
			// GreetingForm
			// 
			...
			this->ClientSize = System::Drawing::Size(770, 681);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		// Створюємо новий екземпляр форми MyForm.h
		MyForm^ myForm = gcnew MyForm();
		this->Hide();
		// Відображаємо форму MyForm.h
		myForm->ShowDialog();

		// Закриваємо поточну форму GreetingForm.h
		this->Close();
